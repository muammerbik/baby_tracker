...
void setupGetIt() {
  ...
  locator.registerSingleton<SettingViewModel>(SettingViewModel());
   locator.registerSingleton<FedingLocalStorageHive>(FeedingStorage());
  locator.registerSingleton<DiaperLocalStorageHive>(DiaperStorage());
  locator.registerSingleton<SleepLocalStorageHive>(SleepStorage());
